...
class ChatInterface {
    constructor() {
        ...
        this.selectedBots = ['llama4-maverick-17b-128e-instruct', 'llama4-scout-17b-16e-instruct', 'qwen-3-32b'];
        ...
        this.selectedBots.forEach((botId, index) => {
            ...
            setTimeout(async () => {
                ...
                if (index === this.selectedBots.length - 1) {
                    ...
                    concatDiv.innerHTML = `<div class="compare-response-header"><strong>Combined Response</strong></div><div class="compare-response-content">${botResponses.map(r => this.formatAnswer(r)).join('<hr style=\"margin:1em 0;\">')}</div>`;
